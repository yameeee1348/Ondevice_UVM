...
class adder_sequence extends uvm_sequence;
    ...
    virtual task  body();
        ...
        repeat(100) begin
            ...
            `uvm_error("SEQ", "Data send to Driver", UVM_NONE);
...
class adder_driver extends uvm_driver #(adder_seq_item);
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if (!uvm_config_db#(virtual adder_if)::get(this, "", "a_if", a_if)) begin
            `uvm_faltal(get_name(), "Unable to access adder interface");
...
class adder_scoreboard extends uvm_scoreboard;
    ...
    virtual function void write(adder_seq_item data);
        ...
        if (data.a + data.b == data.y) begin
            ...
            `uvm_error("SCB", $sformatf("FAIL, a:%d + b:%0d != y:%0d", data.a, data.b, data.y));
        end
...
class adder_environment extends uvm_env;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        super.build_phase(phase);
        a_agt = adder_agent::type_id::create("AGT", this); //adder_agent: 내가 만들 에이전트
        a_scb = adder_scoreboard::type_id::create("SCB", this);//adder_scoreboard:내가 만들 스코어보드
...
class adder_test extends uvm_test;
    ...
    virtual task  run_pahse(uvm_phase phase);
